...
`timescale 1 ps / 1 ps
module max10_adc_mm_interconnect_0 (
	...
	wire  [102:0] modular_adc_0_sample_store_csr_agent_rf_source_data;                // modular_adc_0_sample_store_csr_agent:rf_source_data -> modular_adc_0_sample_store_csr_agent_rsp_fifo:in_data
	...
	wire  [102:0] modular_adc_0_sample_store_csr_agent_rsp_fifo_out_data;             // modular_adc_0_sample_store_csr_agent_rsp_fifo:out_data -> modular_adc_0_sample_store_csr_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> modular_adc_0_sample_store_csr_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> modular_adc_0_sample_store_csr_agent:cp_data
	wire          cmd_mux_src_ready;                                                  // modular_adc_0_sample_store_csr_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> modular_adc_0_sample_store_csr_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> modular_adc_0_sample_store_csr_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> modular_adc_0_sample_store_csr_agent:cp_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                              // cmd_mux_001:src_valid -> modular_adc_0_sequencer_csr_agent:cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> modular_adc_0_sequencer_csr_agent:cp_data
	wire          cmd_mux_001_src_ready;                                              // modular_adc_0_sequencer_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> modular_adc_0_sequencer_csr_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                      // cmd_mux_001:src_startofpacket -> modular_adc_0_sequencer_csr_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                        // cmd_mux_001:src_endofpacket -> modular_adc_0_sequencer_csr_agent:cp_endofpacket
	...
	wire          modular_adc_0_sample_store_csr_agent_rp_valid;                      // modular_adc_0_sample_store_csr_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] modular_adc_0_sample_store_csr_agent_rp_data;                       // modular_adc_0_sample_store_csr_agent:rp_data -> router_001:sink_data
	wire          modular_adc_0_sample_store_csr_agent_rp_ready;                      // router_001:sink_ready -> modular_adc_0_sample_store_csr_agent:rp_ready
	wire          modular_adc_0_sample_store_csr_agent_rp_startofpacket;              // modular_adc_0_sample_store_csr_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          modular_adc_0_sample_store_csr_agent_rp_endofpacket;                // modular_adc_0_sample_store_csr_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [101:0] router_src_data;                                                    // router:src_data -> master_0_master_limiter:cmd_sink_data
	...
	wire  [101:0] master_0_master_limiter_cmd_src_data;                               // master_0_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [101:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> master_0_master_limiter:rsp_sink_data
	...
	wire  [101:0] master_0_master_limiter_rsp_src_data;                               // master_0_master_limiter:rsp_src_data -> master_0_master_agent:rp_data
	...
	wire          modular_adc_0_sample_store_csr_agent_rdata_fifo_src_valid;          // modular_adc_0_sample_store_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] modular_adc_0_sample_store_csr_agent_rdata_fifo_src_data;           // modular_adc_0_sample_store_csr_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          modular_adc_0_sample_store_csr_agent_rdata_fifo_src_ready;          // avalon_st_adapter:in_0_ready -> modular_adc_0_sample_store_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                      // avalon_st_adapter:out_0_valid -> modular_adc_0_sample_store_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                       // avalon_st_adapter:out_0_data -> modular_adc_0_sample_store_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                      // modular_adc_0_sample_store_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                      // avalon_st_adapter:out_0_error -> modular_adc_0_sample_store_csr_agent:rdata_fifo_sink_error
	wire          modular_adc_0_sequencer_csr_agent_rdata_fifo_src_valid;             // modular_adc_0_sequencer_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] modular_adc_0_sequencer_csr_agent_rdata_fifo_src_data;              // modular_adc_0_sequencer_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          modular_adc_0_sequencer_csr_agent_rdata_fifo_src_ready;             // avalon_st_adapter_001:in_0_ready -> modular_adc_0_sequencer_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                  // avalon_st_adapter_001:out_0_valid -> modular_adc_0_sequencer_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                   // avalon_st_adapter_001:out_0_data -> modular_adc_0_sequencer_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                  // modular_adc_0_sequencer_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                  // avalon_st_adapter_001:out_0_error -> modular_adc_0_sequencer_csr_agent:rdata_fifo_sink_error
	...
	max10_adc_mm_interconnect_0_router router (
	...
	max10_adc_mm_interconnect_0_router_001 router_001 (
	...
	max10_adc_mm_interconnect_0_router_001 router_002 (
	...
	max10_adc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	max10_adc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	max10_adc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	max10_adc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	max10_adc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	max10_adc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	max10_adc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_0_data      (modular_adc_0_sample_store_csr_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (modular_adc_0_sample_store_csr_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (modular_adc_0_sample_store_csr_agent_rdata_fifo_src_ready), //         .ready
